...
import { dt as extensions } from "./Geometry-CIU8Erel.js";
import { Es as Application$1, ci as TextStyle, sa as Graphics } from "./lib-BTW_K6Us.js";
import { l as Container, t as Filter } from "./Filter-BkSHT-T6.js";
...
//#endregion
//#region node_modules/@pixi/react/lib/components/Context.mjs
...
Context.Consumer;
//#endregion
//#region node_modules/@pixi/react/lib/helpers/isReadOnlyProperty.mjs
function isReadOnlyProperty(objectInstance, propertyKey) {
	const propertyDescriptor = Object.getOwnPropertyDescriptor(Object.getPrototypeOf(objectInstance), propertyKey);
	return !(typeof propertyDescriptor === "undefined" || propertyDescriptor.writable || propertyDescriptor.set);
}
//#endregion
//#region node_modules/@pixi/react/lib/store.mjs
var store = {
...
//#endregion
//#region node_modules/@pixi/react/lib/helpers/log.mjs
...
//#endregion
//#region node_modules/@pixi/react/lib/helpers/prepareInstance.mjs
...
var packageData = {
	...
	bugs: { url: "https://github.com/pixijs/pixi-react/issues" },
	repository: {
		type: "git",
	...
	"lint-staged": { "*.{ts,js,mjs}": ["eslint --cache --fix --max-warnings 0"] },
	dependencies: {
		"its-fine": "^2.0.0",
...
//#endregion
//#region node_modules/@pixi/react/lib/helpers/afterActiveInstanceBlur.mjs
function afterActiveInstanceBlur() {
	log("info", "lifecycle::afterActiveInstanceBlur");
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/attach.mjs
function attach(parentInstance, childInstance, targetIndex) {
	if (childInstance instanceof Filter) {
		...
		if (typeof targetIndex === "number") parentInstance.__pixireact.filters.splice(targetIndex, 0, childInstance);
		else parentInstance.__pixireact.filters.push(childInstance);
		parentInstance.filters = parentInstance.__pixireact.filters;
	}
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/appendChild.mjs
function appendChild(parentNode, childNode) {
	log("info", "lifecycle::appendChild");
	if (!childNode) return;
	if (childNode instanceof Container) parentNode.addChild(childNode);
	else if (childNode instanceof Filter) attach(parentNode, childNode);
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/beforeActiveInstanceBlur.mjs
function beforeActiveInstanceBlur() {
	log("info", "lifecycle::beforeActiveInstanceBlur");
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/clearContainer.mjs
function clearContainer() {
	log("info", "lifecycle::clearContainer");
	return false;
}
//#endregion
//#region node_modules/@pixi/react/lib/constants/EventPropNames.mjs
...
//#endregion
//#region node_modules/@pixi/react/lib/helpers/compare.mjs
...
function isEqual(inputA, inputB, options = {
	...
	if (typeof inputA !== typeof inputB || !!inputA !== !!inputB) return false;
	if (isString(inputA) || isNumber(inputA)) return inputA === inputB;
	...
	if (isInputAAnArray && arrays === "reference") return inputA === inputB;
	if ((isInputAAnArray || isInputAAnObject) && inputA === inputB) return true;
	let key;
	for (key in inputA) if (!(key in inputB)) return false;
	let input = inputA;
	if (strict) input = inputB;
	if (isInputAAnObject && arrays === "shallow" && objects === "shallow") {
		for (key in input) if (!isEqual(inputA[key], inputB[key], {
			strict,
			objects: "reference"
		})) return false;
	} else for (key in input) if (inputA[key] !== inputB[key]) return false;
	if (isUndefined(key)) {
		if (isInputAAnArray && inputA.length === 0 && inputB.length === 0) return true;
		if (isInputAAnObject && Object.keys(inputA).length === 0 && Object.keys(inputB).length === 0) return true;
...
//#endregion
//#region node_modules/@pixi/react/lib/constants/ReactIgnoredProps.mjs
...
//#endregion
//#region node_modules/@pixi/react/lib/helpers/gentleClone.mjs
function gentleClone(object, ignoredKeys = []) {
	return Object.entries(object).reduce((accumulator, [key, value]) => {
		if (!ignoredKeys.includes(key)) accumulator[key] = value;
		return accumulator;
	}, {});
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/gentleCloneProps.mjs
...
//#endregion
//#region node_modules/@pixi/react/lib/helpers/diffProps.mjs
var DEFAULT$1 = "__default";
function diffProps(newProps, oldProps = {}, remove = false) {
	...
	if (remove) {
		...
		while (propIndex < oldPropsKeys.length) {
			...
			if (!(propKey in newPropsRest)) entries.unshift([propKey, `${DEFAULT$1}remove`]);
			propIndex += 1;
		}
	}
	entries.forEach(([key, value]) => {
		if (isEqual(value, oldPropsRest[key])) return;
...
//#endregion
//#region node_modules/@pixi/react/lib/helpers/isDiffSet.mjs
function isDiffSet(input) {
	const inputAsDiffSet = input;
	if (!inputAsDiffSet) return false;
	if (!inputAsDiffSet.changes) return false;
	return true;
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/applyProps.mjs
...
function applyProps(instance, data) {
	...
	let typedData;
	if (isDiffSet(data)) typedData = data;
	else typedData = diffProps(data, instanceProps);
	...
	while (changeIndex < changes.length) {
		...
		if (key === "draw" && typeof value === "function") if (instance instanceof Graphics) value(instance);
		else {
			hasError = true;
		...
		if (!hasError) {
			...
			if (value === `${DEFAULT}remove`) if (currentInstance instanceof Container) {
			...
			if (isEvent && instanceState) {
				const pixiKey = ReactToPixiEventPropNames[key];
				if (value) currentInstance[pixiKey] = value;
				else delete currentInstance[pixiKey];
			} else if (!isReadOnlyProperty(currentInstance, key)) currentInstance[key] = value;
		}
		changeIndex += 1;
	}
	return instance;
...
//#endregion
//#region node_modules/@pixi/react/lib/helpers/prepareUpdate.mjs
function prepareUpdate(_instance, _type, oldProps, newProps) {
	log("info", "lifecycle::prepareUpdate");
	const { children: newChildren, ...newPropsRest } = newProps;
	const { children: oldChildren, ...oldPropsRest } = oldProps;
	const diff = diffProps(newPropsRest, oldPropsRest, true);
	if (diff.changes.length) return diff;
	return null;
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/commitUpdate.mjs
function commitUpdate(instance, type, oldProps, newProps) {
	...
	if (diff) applyProps(instance, diff);
}
//#endregion
//#region node_modules/@pixi/react/lib/constants/PixiReactIgnoredProps.mjs
var PixiReactIgnoredProps = Object.freeze([...Object.keys(PixiToReactEventPropNames), "draw"]);
//#endregion
//#region node_modules/@pixi/react/lib/helpers/catalogue.mjs
var catalogue = {};
//#endregion
//#region node_modules/@pixi/react/lib/helpers/convertStringToPascalCase.mjs
...
//#endregion
//#region node_modules/@pixi/react/lib/helpers/parseComponentType.mjs
...
function parseComponentType(type) {
	let parsedType = type;
	if (type.startsWith("pixi")) parsedType = type.replace(/^pixi([A-Z])/, lowercaseFirstCharacter);
	return parsedType;
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/createInstance.mjs
function createInstance(type, props, root) {
	...
	if (!(name in catalogue)) throw new Error(`${name} is not part of the PIXI namespace! Did you forget to extend?`);
...
var require_react_reconciler_development = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = function($$$config) {
		...
		exports$2.createContainer = function(containerInfo, tag, hydrationCallbacks, isStrictMode, concurrentUpdatesByDefaultOverride, identifierPrefix, onUncaughtError, onCaughtError, onRecoverableError, transitionCallbacks) {
		...
		exports$2.createHydrationContainer = function(initialChildren, callback, containerInfo, tag, hydrationCallbacks, isStrictMode, concurrentUpdatesByDefaultOverride, identifierPrefix, onUncaughtError, onCaughtError, onRecoverableError, transitionCallbacks, formState) {
		...
		exports$2.defaultOnCaughtError = function(error, errorInfo) {
		...
		exports$2.defaultOnUncaughtError = function(error, errorInfo) {
			reportGlobalError(error);
		...
		exports$2.findHostInstance = function(component) {
		...
		exports$2.findHostInstanceWithWarning = function(component, methodName) {
			var fiber = component._reactInternals;
			if (void 0 === fiber) {
				if ("function" === typeof component.render) throw Error("Unable to find node on an unmounted component.");
				component = Object.keys(component).join(",");
		...
		exports$2.flushPassiveEffects = flushPassiveEffects;
		...
		exports$2.shouldError = function(fiber) {
			return shouldErrorImpl(fiber);
		};
		exports$2.shouldSuspend = function(fiber) {
		...
		exports$2.updateContainerSync = updateContainerSync;
		return exports$2;
	}, module.exports.default = module.exports, Object.defineProperty(module.exports, "__esModule", { value: !0 });
}));
var createReconciler = (/* @__PURE__ */ __toESM((/* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = require_react_reconciler_development();
})))(), 1)).default;
//#endregion
//#region node_modules/@pixi/react/lib/helpers/createTextInstance.mjs
...
//#endregion
//#region node_modules/@pixi/react/lib/helpers/detachDeletedInstance.mjs
function detachDeletedInstance() {
	log("info", "lifecycle::detachDeletedInstance");
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/finalizeInitialChildren.mjs
function finalizeInitialChildren() {
	log("info", "lifecycle::finalizeInitialChildren");
	return false;
}
//#endregion
//#region node_modules/@pixi/react/lib/constants/NO_CONTEXT.mjs
var NO_CONTEXT = {};
//#endregion
//#region node_modules/@pixi/react/lib/helpers/getChildHostContext.mjs
function getChildHostContext(childHostContext) {
	log("info", "lifecycle::getChildHostContext");
	return childHostContext ?? NO_CONTEXT;
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/getCurrentUpdatePriority.mjs
function getCurrentUpdatePriority() {
	log("info", "lifecycle::getCurrentUpdatePriority");
	return store.currentUpdatePriority;
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/getInstanceFromNode.mjs
function getInstanceFromNode() {
	log("info", "lifecycle::getInstanceFromNode");
	return null;
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/getInstanceFromScope.mjs
function getInstanceFromScope(_scope) {
	log("info", "lifecycle:getInstanceFromScope");
	throw new Error("Not yet implemented.");
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/getPublicInstance.mjs
function getPublicInstance(instance) {
	log("info", "lifecycle::getPublicInstance");
	return instance;
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/getRootHostContext.mjs
function getRootHostContext() {
	log("info", "lifecycle::getRootHostContext");
	return NO_CONTEXT;
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/hideInstance.mjs
function hideInstance(instance) {
	if (instance instanceof Container) instance.visible = false;
	else if (instance instanceof Filter) instance.enabled = false;
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/hideTextInstance.mjs
function hideTextInstance(_textInstance) {
	log("info", "lifecycle::hideTextInstance");
	throw new Error("Text instances are not yet supported. Please use a `<text>` component.");
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/detach.mjs
...
//#endregion
//#region node_modules/@pixi/react/lib/helpers/invariant.mjs
...
//#endregion
//#region node_modules/@pixi/react/lib/helpers/insertBefore.mjs
function insertBefore(parentInstance, childInstance, beforeChildInstance) {
	...
	if (childInstance instanceof Container) {
		...
		if (childContainerInstance.parent === parentInstance) parentInstance.removeChild(childContainer);
		...
		const targetIndex = childInstance.__pixireact.filters.indexOf(beforeChildInstance);
		detach(childInstance);
		attach(parentInstance, childInstance, targetIndex);
	}
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/maySuspendCommit.mjs
function maySuspendCommit() {
	log("info", "lifecycle::maySuspendCommit");
	return false;
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/preloadInstance.mjs
function preloadInstance() {
	log("info", "lifecycle::preloadInstance");
	return true;
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/prepareForCommit.mjs
function prepareForCommit() {
	log("info", "lifecycle::prepareForCommit");
	return null;
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/preparePortalMount.mjs
function preparePortalMount() {
	log("info", "lifecycle::preparePortalMount");
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/prepareScopeUpdate.mjs
function prepareScopeUpdate() {
	log("info", "lifecycle::prepareScopeUpdate");
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/removeChild.mjs
function removeChild(_parentInstance, childInstance) {
	log("info", "lifecycle::removeChild");
	if (childInstance instanceof Filter) detach(childInstance);
	childInstance.destroy();
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/requestPostPaintCallback.mjs
function requestPostPaintCallback(_callback) {
	log("info", "lifecycle::requestPostPaintCallback");
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/resetAfterCommit.mjs
function resetAfterCommit() {
	log("info", "lifecycle::resetAfterCommit");
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/resetFormInstance.mjs
function resetFormInstance() {
	log("info", "lifecycle::resetFormInstance");
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/resolveEventTimeStamp.mjs
function resolveEventTimeStamp() {
	log("info", "lifecycle::resolveEventTimeStamp");
	return -1.1;
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/resolveEventType.mjs
function resolveEventType() {
	log("info", "lifecycle::resolveEventType");
	return null;
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/resolveUpdatePriority.mjs
function resolveUpdatePriority() {
	log("info", "lifecycle::resolveUpdatePriority");
	if (store.currentUpdatePriority) return store.currentUpdatePriority;
...
//#endregion
//#region node_modules/@pixi/react/lib/helpers/setCurrentUpdatePriority.mjs
function setCurrentUpdatePriority(newPriority) {
	log("info", "lifecycle::setCurrentUpdatePriority");
	store.currentUpdatePriority = newPriority;
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/shouldAttemptEagerTransition.mjs
function shouldAttemptEagerTransition() {
	log("info", "lifecycle::shouldAttemptEagerTransition");
	return false;
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/shouldSetTextContent.mjs
function shouldSetTextContent() {
	log("info", "lifecycle::shouldSetTextContent");
	return false;
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/startSuspendingCommit.mjs
function startSuspendingCommit() {
	log("info", "lifecycle::startSuspendingCommit");
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/suspendInstance.mjs
function suspendInstance() {
	log("info", "lifecycle::suspendInstance");
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/trackSchedulerEvent.mjs
function trackSchedulerEvent() {
	log("info", "lifecycle::trackSchedulerEvent");
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/unhideInstance.mjs
function unhideInstance(instance) {
	if (instance instanceof Container) instance.visible = true;
	else if (instance instanceof Filter) instance.enabled = true;
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/unhideTextInstance.mjs
function unhideTextInstance(_textInstance) {
	log("info", "lifecycle::unhideTextInstance");
	throw new Error("Text instances are not yet supported. Please use a `<text>` component.");
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/waitForCommitToBeReady.mjs
function waitForCommitToBeReady() {
	log("info", "lifecycle::waitForCommitToBeReady");
	return null;
}
//#endregion
//#region node_modules/@pixi/react/lib/core/reconciler.mjs
...
//#endregion
//#region node_modules/@pixi/react/lib/core/roots.mjs
var roots = /* @__PURE__ */ new Map();
//#endregion
//#region node_modules/@pixi/react/lib/core/createRoot.mjs
function createRoot(target, options = {}) {
	...
	if (root) log("warn", "createRoot should only be called once!");
	else {
		applicationState.app = new Application$1();
		internalState.rootContainer = prepareInstance(applicationState.app.stage);
	}
	const fiber = root?.fiber ?? reconciler.createContainer(internalState.rootContainer, 1, null, false, null, "", console.error, console.error, console.error, null);
	if (!root) {
		let canvas;
		...
		const render = async (children, applicationOptions) => {
			...
			Object.entries(applicationOptions).forEach(([key, value]) => {
				const typedKey = key;
				if (isReadOnlyProperty(applicationOptions, typedKey)) return;
				applicationState.app[typedKey] = value;
			});
			reconciler.updateContainer(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ContextProvider, {
...
//#endregion
//#region node_modules/@pixi/react/lib/helpers/unmountRoot.mjs
function unmountRoot(root) {
	store.unmountQueue.delete(root);
	const fiber = root.fiber;
	if (fiber) reconciler.updateContainer(null, fiber, null, () => {
		if (root.applicationState.app) root.applicationState.app.destroy();
		roots.delete(root.internalState.canvas);
	});
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/processUnmountQueue.mjs
function processUnmountQueue() {
	for (const root of store.unmountQueue) unmountRoot(root);
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/queueForUnmount.mjs
function queueForUnmount(canvas) {
	const root = roots.get(canvas);
	if (root) if (root.applicationState.isInitialised) unmountRoot(root);
	else store.unmountQueue.add(root);
}
//#endregion
//#region node_modules/@pixi/react/lib/helpers/unqueueForUnmount.mjs
function unqueueForUnmount(canvas) {
	const root = roots.get(canvas);
	if (root) store.unmountQueue.delete(root);
}
//#endregion
//#region node_modules/@pixi/react/lib/hooks/useIsomorphicLayoutEffect.mjs
var useIsomorphicLayoutEffect = typeof window !== "undefined" && (window.document?.createElement || window.navigator?.product === "ReactNative") ? import_react.useLayoutEffect : import_react.useEffect;
//#endregion
//#region node_modules/@pixi/react/lib/components/Application.mjs
var originalDefaultTextStyle = { ...TextStyle.defaultTextStyle };
var ApplicationImplementation = (0, import_react.forwardRef)(function Application2(props, forwardedRef) {
	const { children, className, defaultTextStyle, extensions: extensions$1, onInit, resizeTo, ...applicationProps } = props;
	const Bridge = x();
	const applicationRef = (0, import_react.useRef)(null);
	const canvasRef = (0, import_react.useRef)(null);
	const extensionsRef = (0, import_react.useRef)(/* @__PURE__ */ new Set());
	...
	const updateResizeTo = (0, import_react.useCallback)(() => {
		const application = applicationRef.current;
		if (application) if (resizeTo) if ("current" in resizeTo) {
			if (resizeTo.current instanceof HTMLElement) application.resizeTo = resizeTo.current;
		} else application.resizeTo = resizeTo;
		else application.resizeTo = void 0;
	}, [resizeTo]);
	const handleInit = (0, import_react.useCallback)((application) => {
		processUnmountQueue();
	...
	useIsomorphicLayoutEffect(() => {
		...
		if (canvasElement) {
			...
			if (!root) root = createRoot(canvasElement, { onInit: handleInit });
			root.render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Bridge, { children }), applicationProps);
		}
	}, [
		applicationProps,
		children,
	...
	useIsomorphicLayoutEffect(() => {
		if (defaultTextStyle) Object.assign(TextStyle.defaultTextStyle, defaultTextStyle);
		else Object.assign(TextStyle.defaultTextStyle, originalDefaultTextStyle);
	}, [defaultTextStyle]);
...
var Application = (0, import_react.forwardRef)(function ApplicationWrapper(props, ref) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(m, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ApplicationImplementation, {
		ref,
		...props
	}) });
});
//#endregion
//#region node_modules/@pixi/react/lib/helpers/extend.mjs
function extend(objects) {
	Object.assign(catalogue, objects);
}
//#endregion
//#region node_modules/@pixi/react/lib/hooks/useApplication.mjs
function useApplication() {
	const appContext = (0, import_react.useContext)(Context);
	invariant(appContext.app instanceof Application$1, "No Context found with `%s`. Make sure to wrap component with `%s`", "Application", "AppProvider");
	return appContext;
}
//#endregion
//#region node_modules/@pixi/react/lib/hooks/useExtend.mjs
...
//#endregion
//#region node_modules/@pixi/react/lib/hooks/useTick.mjs
function useTick(options) {
	...
	useIsomorphicLayoutEffect(() => {
		if (isInitialised) {
			...
			if (isEnabled && ticker) ticker.add(callback, context, priority);
			return () => {
				if (wasEnabled) ticker?.remove(previousCallback, previousContext);
			};
		}
	}, [
		app?.ticker,
...
//#endregion
export { Application, applyProps, createRoot, extend, useApplication, useExtend, useTick };
